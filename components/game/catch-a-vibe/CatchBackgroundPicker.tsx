...
export function CatchBackgroundPicker({
  selectedId,
  muted,
  onSelect,
}: {
  ...
  return (
    <div className="space-y-2">
      <p className="font-display text-[10px] font-bold uppercase tracking-widest text-white/65">Arena background</p>
          ...
          return (
            <button
              ...
              className={`relative overflow-hidden rounded-xl border text-left transition ${
                on ? "border-gvc-gold ring-2 ring-gvc-gold/40" : "border-white/10 hover:border-gvc-gold/35"
              }`}
            >
